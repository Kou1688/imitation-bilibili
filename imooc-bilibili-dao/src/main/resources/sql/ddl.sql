...
CREATE TABLE `t_auth_element_operation` (
                                            ...
                                            `element_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '页面元素名称',
                                            `element_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '页面元素唯一编码',
                                            `operation_type` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '操作类型：0可点击  1可见',
...
CREATE TABLE `t_user_following` (
                                    `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键id',
                                    `user_id` bigint DEFAULT NULL COMMENT '用户id',
                                    `following_id` int DEFAULT NULL COMMENT '关注用户id',
                                    `group_id` int DEFAULT NULL COMMENT '关注分组id',
                                    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
                                    PRIMARY KEY (`id`)
